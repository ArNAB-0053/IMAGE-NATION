...
import { Montserrat, Playfair_Display, Poppins, Anton, Teko, Titillium_Web, Lexend_Giga, Source_Code_Pro, Oswald } from "next/font/google";
    ...
    <section className="relative w-full min-h-screen flex items-center justify-center  text-white overflow-hidden ">
      ...
      <div className="container max-w-6xl mx-auto px-4 md:px-6 z-10">
        <div className="flex flex-col items-center text-center space-y-10">
          ...
          >
            <Button 
              className={`${poppins.className} text-lg px-8 py-6 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 rounded-full font-medium`}
              onClick={() => {
                document
